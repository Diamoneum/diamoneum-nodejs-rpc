...
var DiamoneumdRPC = function (opts) {
  opts = opts || {}
  if (!(this instanceof DiamoneumdRPC)) return new DiamoneumdRPC(opts)
...
DiamoneumdRPC.prototype.getBlocks = function (opts) {
...
DiamoneumdRPC.prototype.getBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DiamoneumdRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
DiamoneumdRPC.prototype.getTransactionPool = function () {
  return new Promise((resolve, reject) => {
...
DiamoneumdRPC.prototype.getBlockCount = function () {
  return new Promise((resolve, reject) => {
...
DiamoneumdRPC.prototype.getBlockHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
DiamoneumdRPC.prototype.getBlockTemplate = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DiamoneumdRPC.prototype.submitBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DiamoneumdRPC.prototype.getLastBlockHeader = function () {
  return new Promise((resolve, reject) => {
...
DiamoneumdRPC.prototype.getBlockHeaderByHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
DiamoneumdRPC.prototype.getBlockHeaderByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
DiamoneumdRPC.prototype.getCurrencyId = function () {
  return new Promise((resolve, reject) => {
...
DiamoneumdRPC.prototype.getHeight = function () {
  return this.height()
}

DiamoneumdRPC.prototype.height = function () {
  return new Promise((resolve, reject) => {
...
DiamoneumdRPC.prototype.getInfo = function () {
  return this.info()
}

DiamoneumdRPC.prototype.info = function () {
  return new Promise((resolve, reject) => {
...
DiamoneumdRPC.prototype.feeInfo = function () {
  return this.fee()
}

DiamoneumdRPC.prototype.fee = function () {
  return new Promise((resolve, reject) => {
    return reject(new Error('Not implemented'))
  })
}

DiamoneumdRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DiamoneumdRPC.prototype.getPeers = function () {
  return this.peers()
}

DiamoneumdRPC.prototype.peers = function () {
  return new Promise((resolve, reject) => {
...
DiamoneumdRPC.prototype.sendRawTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    return reject(new Error('Not implemented'))
  })
}

DiamoneumdRPC.prototype._get = function (method) {
  return new Promise((resolve, reject) => {
...
DiamoneumdRPC.prototype._post = function (method, params) {
  return new Promise((resolve, reject) => {
    if (method.length === 0) return reject(new Error('no method supplied'))
    params = params || {}
...
DiamoneumdRPC.prototype._rawPost = function (endpoint, body) {
  return new Promise((resolve, reject) => {
